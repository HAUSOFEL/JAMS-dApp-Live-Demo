      ...
      >
        ...
        {selected ? (
          <div className="fixed bottom-20 left-1/2 z-40 w-[calc(100%-24px)] max-w-[370px] -translate-x-1/2 box-border">
            <div className="max-h-[38vh] overflow-y-auto rounded-2xl border border-border bg-surface/95 p-3 shadow-2xl backdrop-blur-xl">
          ...
          <div className="fixed bottom-20 left-1/2 z-40 w-[calc(100%-24px)] max-w-[370px] -translate-x-1/2 box-border">
            <p className="rounded-2xl border border-border bg-surface/80 px-4 py-3 text-center text-[12px] text-muted-foreground backdrop-blur-xl">
