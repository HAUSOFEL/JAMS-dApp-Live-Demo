          ...
          >
            ...
            <button
              ...
              style={
                story.creator.accentColor
                  ? { background: story.creator.accentColor, color: "var(--primary-foreground)" }
                  : undefined
              }
            >
            ...
            {story.isLive ? (
              <button
                ...
                className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 rounded-md border-2 border-surface bg-live px-1.5 py-0.5 text-[9px] font-black uppercase text-live-foreground"
              >
                Live
              </button>
            ) : null}
